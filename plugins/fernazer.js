...
const vcard = 'BEGIN:VCARD\n' // jangan ganti
            ...
            + 'FN:PANN\n' // ganti aja 
            + 'ORG: PANN;\n' // ganti aja
            + 'TEL;type=CELL;type=VOICE;waid=6288227606701:+6288227606701\n'  //ganti nomor lu
...
replitx = '*BY PANN' 
ari = '*NIGHTBOT*'
limitawal = 20 // terserah mau ganti apa gak 
memberlimit = 20 // terserah mau ganti apa gak 
namabot = 'NIGHTBOT'
cr = '*「 NIGHTBOT 」*' //ganti nama bot
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6288227606701@s.whatsapp.net"]   //ganti nomor lu
//================================ Batas ========================
battre = batre
charg = chargi
charging = false
...
console.log(color('WELCOME DI WA CONNECTION NIGHTBOT, SILAHKAN SCAN KODE DI BAWAH','green'))
...
console.log(color('BASE PANN MENGINTAI DARI JAUH KAMI TAU APA YG ANDA LAKUKAN PD BOT','red'))
...
${tf} Prefix : ${prefix}
${tf} Nomor Bot : http://wa.me/+17155448800
╰══──────────══─⊱
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6288227606701@s.whatsapp.net', options, text, {quoted: mek})
		...
		case 'request':
					...
					client.sendMessage('6288227606701@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6288227606701@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER(PANN) REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
...
║╠ Contoh: 
║╠ #suratto 6288227606701|Hai Juga
║╚▸
╚═══ ◤ *${namabot}* ◢ `
